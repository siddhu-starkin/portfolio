...
export const App = () => {
  return (
    <body className="text-neutral-950 text-base not-italic normal-nums font-normal accent-auto bg-white box-border caret-transparent block tracking-[normal] leading-6 list-outside list-disc pointer-events-auto text-start indent-[0px] normal-case visible w-full border-separate font-geistsans_fb8f2c">
    ...
    >
      ...
      <div className="relative box-border caret-transparent min-h-0 min-w-0 md:min-h-[auto] md:min-w-[auto]">
        <a
          aria-label="about"
          href="/"
          className="relative text-neutral-900 text-sm font-medium box-border caret-transparent leading-5 px-4 py-2"
        >
          About
      ...
      <div className="relative box-border caret-transparent min-h-0 min-w-0 md:min-h-[auto] md:min-w-[auto]">
        ...
        >
          Career
          <span className="absolute bg-neutral-900 box-border caret-transparent block h-0.5 transform-none origin-[0%_50%] bottom-1.5 inset-x-4 md:scale-x-0"></span>
        </a>
      </div>
      <div className="relative box-border caret-transparent min-h-0 min-w-0 md:min-h-[auto] md:min-w-[auto]">
        <a
      ...
      <MobileNavLink
        ...
        href="/career"
        text="Career"
        linkVariant="hover:text-neutral-900"
